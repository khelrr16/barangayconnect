                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2 text-center">
                                        <a href="{{ route('household.show', $household->id) }}" class="btn btn-warning btn-sm">VIEW</a>
                                        @can('manage households')
                                        <a href="{{ route('household.edit', $household->id) }}" class="btn btn-warning btn-sm">EDIT</a>
                                        @endcan
                                    </div>
                                </td>
                            </tr>
