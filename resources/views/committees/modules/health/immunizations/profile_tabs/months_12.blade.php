...
<div class="m-3 bg-white border rounded-5">
    ...
    <div class="p-3">
        ...
        <div class="mt-3 d-flex align-items-center justify-content-around text-center">
            <!-- FIC -->
            <div>
                <h4 class="fw-bold p-1">Fully Immunized Child (FIC)</h4>
                @if($infant->fic)
                    <h4 class="fw-bold text-success p-1">{{ optional($infant->fic)->format('M d, Y') ?? '' }}</h4>
                @else
            ...
            <!-- CIC -->
            <div>
                <h4 class="fw-bold p-1">Completely Immunized Child (CIC)</h4>
                @if($infant->cic)
                    <h4 class="fw-bold text-success p-1">{{ optional($infant->cic)->format('M d, Y') ?? '' }}</h4>
                @else
                    <h4 class="fw-bold text-secondary p-1">UNSET</h4>
                @endif
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Nutritional Status Assessment (12 months old)</h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-3">
                    ...
                    <div class="mb-4 p-3 border rounded-3 bg-secondary bg-opacity-10">
                        <div class="mb-3">
                            <label class="form-label text-muted">Fully Immunized Child (FIC)</label>
                            <input type="date" name="fic" class="form-control" value="{{ old('fic', optional($infant->fic)->format('Y-m-d') ?? '') }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label text-muted">Completely Immunized Child (CIC)</label>
                            <input type="date" name="cic" class="form-control" value="{{ old('cic', optional($infant->cic)->format('Y-m-d') ?? '') }}">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
